...
export default function AdsPage() {
    ...
    return (
        <div>
            <TopNav
                title="Publicidade"
                subtitle="Gestão de banners e campanhas"
                right={
                    <button
                        onClick={handleCreate}
                        className="flex items-center justify-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-2xl font-bold hover:bg-blue-700 transition-all active:scale-95 group shadow-lg shadow-blue-200"
                    >
                ...
                <div className="max-w-7xl mx-auto space-y-10">
                    <div className="bg-white rounded-[32px] shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div className="overflow-x-auto">
                            <table className="max-w-7xl mx-auto space-y-10">
                                <thead>
